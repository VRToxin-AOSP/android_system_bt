...
const char *SECURE_ONLY_MODE = "SecurePairOnly";
...
static bool get_secure_only_mode(void) {
    return config_get_bool(config, CONFIG_DEFAULT_SECTION, SECURE_ONLY_MODE, false);
}
